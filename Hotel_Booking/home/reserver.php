            ...
            <div id="form">
                ...
                <div id="first-group">
                    ...
                    <div id="content">
                        ...
                        <input type="date" id="input-group" placeholder="Departure Date" name="date_debut">
                    </div>

                    <div id="content">
                        <i class="fa fa-users" aria-hidden="true"></i>
                        <select id="input-group" style="background-color: black;" name ="per" placeholder="No.of guests">
                ...
                <div id="second-group">
                    ...
                    <div id="content">
                        <i class="fa fa-calendar" aria-hidden="true"></i>
                        <input type="date" id="input-group" placeholder="Arrival Date" name="date_fin">
                    </div>
