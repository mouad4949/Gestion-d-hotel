...
<body>
    <div class="container-xxl bg-white p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0 pe-4">
                        <a href class="navbar-brand p-0" style="margin-top: 30px;">
                            <h1 class="text-primary m-0" href="index.php">
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="index.php">Return to
                                    Home</a></li>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
            <div class="row g-0">
                <form action="emptypanier.php" method="post">
                    <?php
                    $query = "SELECT SUM(prix_plat) FROM panier";
                    ...
                    <div class="col-md-12 bg-dark d-flex align-items-center">
                        <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <h1 class="text-white mb-4">Enter your
                                information
                            </h1>
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <?php
                                        echo '<button class="btn btn-primary w-100 py-3" type="submit" name="sumpanier" value="' . $row['SUM(prix_plat)'] . '">Confirm
                                        Payment</button>';
                                        ?>
                                    </div>
                                </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href>Terms &
                            Condition</a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p>Dolor amet sit justo amet elitr clita ipsum
                            elitr
                            est.</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Your
